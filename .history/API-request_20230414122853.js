const teamsTable1 = require('../TeamIdIndex/teamsTable1.js')
...
if (!getWinner1Response.error) {
  first.push(teamsTable1[getWinner1Response.data.standings[0].table[0].team.id])
  tenth.push(teamsTable1[getWinner1Response.data.standings[0].table[9].team.id])
  seventeenth.push(teamsTable1[getWinner1Response.data.standings[0].table[16].team.id])
} else {
...
function calculateMode(arr) {
  ...
  const result = {
    first: calculateMode(first),
    tenth: calculateMode(tenth),
    seventeenth: calculateMode(seventeenth)
  }
