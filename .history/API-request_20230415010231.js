...
if (!getWinner1Response.error) {
  const first = teamsTable1[league][getWinner1Response.data.standings[0].table[0].team.id]
  const tenth = teamsTable1[league][getWinner1Response.data.standings[0].table[9].team.id]
  const seventeenth = teamsTable1[league][getWinner1Response.data.standings[0].table[16].team.id]
} else {
