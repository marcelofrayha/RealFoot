...
function calculateMode(arr) {
  ...
  // let result;
  // if (winner == 0) {result = calculateMode(first)}
  // if (winner == 1) {result = calculateMode(tenth)}
  // if (winner == 2) {result = calculateMode(seventeenth)};

  const result = [calculateMode(first), calculateMode(tenth), calculateMode(seventeenth)];
