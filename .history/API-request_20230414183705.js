...
if (!getWinner1Response.error) {
  first.push(teamsTable1.league[parseInt(getWinner1Response.data.standings[0].table[0].team.id]))
  tenth.push(teamsTable1.league[parseInt(getWinner1Response.data.standings[0].table[9].team.id]))
  seventeenth.push(teamsTable1.league[parseInt(getWinner1Response.data.standings[0].table[16].team.id]))
} else {
